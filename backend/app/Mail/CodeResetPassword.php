...
class CodeResetPassword extends Mailable
{
    ...
    {
        return new Envelope(
            subject: '🔐 Forum UIYA — Réinitialisation de votre mot de passe',
        );
    }
            ...
            htmlString: "
                <div style='font-family:Arial,sans-serif;max-width:500px;margin:auto;'>
                    <div style='background:#7C3AED;padding:24px;text-align:center;border-radius:12px 12px 0 0;'>
                        ...
                        <p style='color:#C4B5FD;margin:8px 0 0;'>Réinitialisation du mot de passe</p>
                    </div>
                    <div style='background:white;padding:30px;text-align:center;'>
                        <p style='color:#6B7280;'>Voici votre code de réinitialisation :</p>
